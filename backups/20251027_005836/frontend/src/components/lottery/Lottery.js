...
const Lottery = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Load lottery data and check GS-I membership
      const [drawData, ticketsData, programsResponse] = await Promise.all([
      ...
      // Check if user has GS-I program or is moderator
